...
//                    nci_newC_V45\Libraries\STM32F10x_StdPeriph_Driver\src\s /
//                    tm32f10x_dma.c -D USE_STDPERIPH_DRIVER -D               /
...
// F:\软件工程\平台正式代码001\Benze_MainBoard\baoma_36\benci_newC_V45\Libraries\STM32F10x_StdPeriph_Driver\src\stm32f10x_dma.c
//    1 /**
//    2   ******************************************************************************
...
//  128     if (DMAy_Channelx == DMA1_Channel1)
        LDR.N    R1,??DataTable5  ;; 0x40020008
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_0
//  129     {
//  130         /* Reset interrupt pending bits for DMA1 Channel1 */
//  131         DMA1->IFCR |= DMA1_Channel1_IT_Mask;
        LDR.N    R1,??DataTable5_1  ;; 0x40020004
        LDR      R1,[R1, #+0]
        ORRS     R1,R1,#0xF
        LDR.N    R2,??DataTable5_1  ;; 0x40020004
        STR      R1,[R2, #+0]
        B.N      ??DMA_DeInit_1
//  132     }
//  133     else if (DMAy_Channelx == DMA1_Channel2)
??DMA_DeInit_0:
        LDR.N    R1,??DataTable5_2  ;; 0x4002001c
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_2
//  134     {
...
??DMA_DeInit_2:
        LDR.N    R1,??DataTable5_3  ;; 0x40020030
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_3
//  139     {
...
??DMA_DeInit_3:
        LDR.N    R1,??DataTable5_4  ;; 0x40020044
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_4
//  144     {
...
??DMA_DeInit_4:
        LDR.N    R1,??DataTable5_5  ;; 0x40020058
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_5
//  149     {
...
??DMA_DeInit_5:
        LDR.N    R1,??DataTable5_6  ;; 0x4002006c
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_6
//  154     {
...
??DMA_DeInit_6:
        LDR.N    R1,??DataTable5_7  ;; 0x40020080
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_7
//  159     {
...
??DMA_DeInit_7:
        LDR.N    R1,??DataTable5_8  ;; 0x40020408
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_8
//  164     {
//  165         /* Reset interrupt pending bits for DMA2 Channel1 */
//  166         DMA2->IFCR |= DMA2_Channel1_IT_Mask;
        LDR.N    R1,??DataTable5_9  ;; 0x40020404
        LDR      R1,[R1, #+0]
        ORRS     R1,R1,#0xF
        LDR.N    R2,??DataTable5_9  ;; 0x40020404
        STR      R1,[R2, #+0]
        B.N      ??DMA_DeInit_1
//  167     }
//  168     else if (DMAy_Channelx == DMA2_Channel2)
??DMA_DeInit_8:
        LDR.N    R1,??DataTable5_10  ;; 0x4002041c
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_9
//  169     {
...
??DMA_DeInit_9:
        LDR.N    R1,??DataTable5_11  ;; 0x40020430
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_10
//  174     {
...
??DMA_DeInit_10:
        LDR.N    R1,??DataTable5_12  ;; 0x40020444
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_11
//  179     {
...
??DMA_DeInit_11:
        LDR.N    R1,??DataTable5_13  ;; 0x40020458
        CMP      R0,R1
        BNE.N    ??DMA_DeInit_1
//  186         {
...
//  222     tmpreg &= CCR_CLEAR_Mask;
        LDR.N    R3,??DataTable5_14  ;; 0xffff800f
        ANDS     R2,R3,R2
...
//  445         tmpreg = DMA2->ISR ;
        LDR.N    R3,??DataTable5_15  ;; 0x40020400
        LDR      R3,[R3, #+0]
        MOVS     R2,R3
...
//  450         tmpreg = DMA1->ISR ;
??DMA_GetFlagStatus_0:
        LDR.N    R3,??DataTable5_16  ;; 0x40020000
        LDR      R3,[R3, #+0]
        MOVS     R2,R3
//  451     }
//  452 
