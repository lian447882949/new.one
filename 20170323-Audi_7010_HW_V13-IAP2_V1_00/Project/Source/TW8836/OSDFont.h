...
#ifdef _OSDFONT_C_
	#define __OSDFONT_C_EXTERN__
#else
	#define __OSDFONT_C_EXTERN__ extern
#endif
...
/*
extern const WORD FOsdHwDefPaletteBpp1[16];
extern const WORD FOsdSwDefPaletteBpp1[16];
extern const WORD FOsdDefPaletteBpp2[4]; 
extern const WORD FOsdDefPaletteBpp3[8];
extern const BYTE FOsdDefPaletteBpp3Alpha[8];
extern const WORD FOsdDefPaletteBpp4[16];
...
BYTE FOsdRamGetWriteMode(WORD addr);
...
__OSDFONT_C_EXTERN__ void FOsdRamClearAll(WORD dat, BYTE attr);
__OSDFONT_C_EXTERN__ void InitFontRamByNum(BYTE FontMode, WORD start);
